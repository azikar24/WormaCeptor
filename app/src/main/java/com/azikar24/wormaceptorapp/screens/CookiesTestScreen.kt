...
/**
 * Test screen for the Cookies Manager feature.
 * Provides a custom UI to test cookie management with CookieManager directly.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CookiesTestScreen(onBack: () -> Unit, modifier: Modifier = Modifier) {
...
@Composable
private fun CookieListItem(cookie: ParsedCookie, onClick: () -> Unit, modifier: Modifier = Modifier) {
    Card(
        modifier = modifier
            .fillMaxWidth()
...
@Composable
private fun CookieDetailSheet(cookie: ParsedCookie, modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxWidth()
...
@Composable
private fun DetailItem(label: String, value: String, isMonospace: Boolean = false, modifier: Modifier = Modifier) {
