...
val MyIconPack.IcGithub: ImageVector
    get() {
        if (_icGithub != null) {
            return _icGithub!!
        }
        _icGithub = Builder(name = "IcGithub", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFFffffff)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(12.0f, 0.0f)
                curveTo(5.374f, 0.0f, 0.0f, 5.373f, 0.0f, 12.0f)
                curveTo(0.0f, 17.302f, 3.438f, 21.8f, 8.207f, 23.387f)
                curveTo(8.806f, 23.498f, 9.0f, 23.126f, 9.0f, 22.81f)
                lineTo(9.0f, 20.576f)
                ...
                curveTo(7.145f, 17.0f, 4.343f, 15.971f, 4.343f, 11.374f)
                ...
                curveTo(9.954f, 5.941f, 10.98f, 5.808f, 12.0f, 5.803f)
                ...
                curveTo(14.607f, 17.667f, 15.0f, 18.397f, 15.0f, 19.517f)
                lineTo(15.0f, 22.81f)
                curveTo(15.0f, 23.129f, 15.192f, 23.504f, 15.801f, 23.386f)
                curveTo(20.566f, 21.797f, 24.0f, 17.3f, 24.0f, 12.0f)
