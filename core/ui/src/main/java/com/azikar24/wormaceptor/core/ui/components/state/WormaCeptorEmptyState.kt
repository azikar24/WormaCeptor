...
fun WormaCeptorEmptyState(
    ...
    Column(
        modifier = modifier
            .padding(WormaCeptorTokens.Spacing.xxl.scaled()),
        ...
        if (icon != null) {
            ...
            Spacer(modifier = Modifier.height(WormaCeptorTokens.Spacing.xxl.scaled()))
        }
        ...
        if (subtitle != null) {
            Spacer(modifier = Modifier.height(WormaCeptorTokens.Spacing.sm.scaled()))
        ...
        if (actionLabel != null && onAction != null) {
            Spacer(modifier = Modifier.height(WormaCeptorTokens.Spacing.xl.scaled()))
            ...
            OutlinedButton(
                ...
                Text(
                    ...
                    modifier = Modifier.padding(
                        horizontal = WormaCeptorTokens.Spacing.sm.scaled(),
                        vertical = WormaCeptorTokens.Spacing.xxs.scaled(),
                    ),
                )
            }
        }
