...
object RateLimitFeature {
    ...
    /**
     * Creates a RateLimitEngine instance.
     * Use this in your dependency injection setup or as a singleton.
     *
     * @return A new RateLimitEngine instance
     */
    fun createEngine(): RateLimitEngine {
    ...
    /**
     * Gets the OkHttp Interceptor from an engine for rate limiting.
     * Add this to your OkHttpClient.Builder.
     *
     * @param engine The RateLimitEngine instance
     * @return The rate limiting interceptor
     */
    fun getInterceptor(engine: RateLimitEngine): Interceptor {
        return engine.getInterceptor()
    }
}
...
/**
 * Main composable for the Network Rate Limiting feature.
 * Displays rate limiting configuration and statistics.
 *
